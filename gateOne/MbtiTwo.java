...
String name = input.nextLine(); 
      ...
      for (int number = 0; number < 4; number++){
         for (displays = number; displays < questions.length; displays = displays + 4){
         ...
         if (countTwoA < countTwoB) choiceTwo = "N"; 
         else choiceTwo = "S";

         if (countThreeA < countThreeB)choiceThree = "F"; 
         else choiceThree = "T"; 
         
         if (countFourA < countFourB) choiceFour = "P"; 
         else choiceFour = "J"; 
